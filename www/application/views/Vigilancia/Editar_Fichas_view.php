...
<h4 class="fw-bold py-3 mb-2"><span class="text-muted fw-light">Editar ficha </span>N° <?php echo $inf_ficha->id ?><br>
    <small class="fw-light fs-6 text-muted">Aquí puedes cambiar la información registrada sobre esta ficha</small>
</h4>
<input type="hidden" name="id" value="<?php echo $inf_ficha->id ?>" id="ficha_value">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="mb-3 col-md-12">
                                ...
                                <input type="text" class="form-control" placeholder="" aria-describedby="basic-addon1" id="responsable_laboratorio" required value="<?php echo $inf_ficha->laboratorio_res ?>">
                            </div>
                            <div class="mb-3 col-md-12">
                                <label for="responsable_epidemiologia" class="form-label">Responsable Epidemiología</label>
                                <input type="text" class="form-control" placeholder="" aria-describedby="basic-addon1" id="responsable_epidemiologia" required value="<?php echo $inf_ficha->epidemio_res ?>">
                            </div>
                            <div class="mb-3 col-md-12">
                                <label for="fecha_notificacion" class="form-label">Fecha de notificación</label>
                                <input type="text" class="form-control flatpickr-input active" placeholder="" aria-describedby="basic-addon1" id="fecha_notificacion" required value="<?php echo $inf_ficha->fecha_not ?>">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <select name="mis_paises" id="mis_paises" class="select2 form-select" required onchange="obtenerProvincia(this)">
                                ...
                                <?php foreach ($paises as $p) { ?>
                                    <option value="<?php echo $p->codigo ?>" <?php echo $p->codigo == $inf_ficha->pais ? 'selected' : '' ?>><?php echo $p->nombre ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <div class="mb-3 col-md-6">
                            ...
                            <select name="mis_departamentos" id="mis_departamentos" class="select2 form-select" onchange="obtenerProvincia(this)">
                                ...
                                <?php foreach ($departamentos as $d) { ?>
                                    <option value="<?php echo $d->iCodDept ?>" <?php echo $d->iCodDept == $inf_ficha->departamento ? 'selected' : '' ?>><?php echo $d->vNombre ?></option>
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <select name="d_tipo_via" id="d_tipo_via" class="select2 form-select" required>
                                            <?php foreach ($tipo_via as $p) { ?>
                                                <option value="<?php echo $p->id ?>" <?php if ($p->id == $inf_ficha->direccion_tipo_via) {
                                                                                            echo 'selected';
                                                                                        } ?>><?php echo $p->denominacion ?></option>
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <select name="d_tipo_asociacion" id="d_tipo_asociacion" class="select2 form-select" required>
                                            <?php foreach ($tipo_asociacion as $p) { ?>
                                                <option value="<?php echo $p->id ?>" <?php if ($p->id == $inf_ficha->direccion_tipo_asociacion) {
                                                                                            echo 'selected';
                                                                                        } ?>><?php echo $p->denominacion ?></option>
                                            <?php } ?>
                                        </select>
...
<script src="<?php echo base_url('public/js/Vigilancia/jsFichasEditar.js') . '?=' . rand(); ?>"></script>