...
<h4 class="fw-bold py-3 mb-2"><span class="text-muted fw-light">Ver ficha </span>N° <?php echo $inf_ficha->id ?><br>
    <small class="fw-light fs-6 text-muted">Aquí verás la información registrada sobre esta ficha</small>
</h4>
...
<script>
    let misInput = document.getElementsByTagName('input')
	let misSelect = document.getElementsByTagName('select')
	let misTextArea = document.getElementsByTagName('textarea')
