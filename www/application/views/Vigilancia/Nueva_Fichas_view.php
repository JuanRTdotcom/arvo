...
<h4 class="fw-bold py-3 mb-2"><span class="text-muted fw-light">Registro de </span>notificación<br>
    <small class="fw-light fs-6 text-muted">Agrega nuevos registros sobre fichas de vigilancia</small>
</h4>
<form action="action/Cwoo231#5-13poO($kkis_u)" id="_registrar_ficha" method="post" class="p-0 m-0">
    <div class="row">
        <div class="col-md-6">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="mb-3 col-md-12">
                                ...
                                <input type="text" class="form-control" placeholder="" id="responsable_laboratorio" required>
                            </div>
                            <div class="mb-3 col-md-12">
                                <label for="responsable_epidemiologia" class="form-label">Responsable Epidemiología</label>
                                <input type="text" class="form-control" placeholder="" id="responsable_epidemiologia" required>
                            </div>
                            <div class="mb-3 col-md-12">
                                <label for="fecha_notificacion" class="form-label">Fecha de notificación</label>
                                <input type="text" class="form-control flatpickr-input active" placeholder="" id="fecha_notificacion">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                ...
                                <div style="display: flex;">
                                    <input class="form-control me-1" type="text" autocomplete="off" required id="dni">
                                    <button type="button" class="btn btn-primary" style="height: 38px;">Reniec</button>
                                </div>
                            </div>
                            <div class="mb-3 col-md-6">
                                <label for="nombres" class="form-label">Nombres</label>
                                <input class="form-control" type="text" name="" id="nombres" autocomplete="off" required>
                            </div>
                            <div class="mb-3 col-md-6">
                                <label for="apellido_paterno" class="form-label">Apellido paterno</label>
                                <input type="text" class="form-control" placeholder="" id="apellido_paterno" autocomplete="off" required>
                            </div>
                            <div class="mb-3 col-md-6">
                                <label for="apellido_materno" class="form-label">Apellido materno</label>
                                <input type="text" class="form-control" placeholder="" id="apellido_materno" autocomplete="off" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="mb-3">
                                    <label class="form-label">Sexo</label>
                                    <div class="flight-types">
                                        <input type="radio" name="flight-type" value="M" id="_masculino" checked />
                                        <label for="_masculino">
                                            Masculino
                                        </label>

                                        <input type="radio" name="flight-type" value="F" id="_femenino" />
                                        <label for="_femenino">
                                            Femenino
                                        </label>
                                    </div>
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <div style="display: flex;">
                                    <input type="number" style="border-radius:4px 0 0 4px;border-right: 0;" class="form-control" placeholder="" id="edad" autocomplete="off" required>
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="number" class="form-control" placeholder="" id="telefono" autocomplete="off" required>
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <select name="mis_departamentos" id="mis_departamentos" class="select2 form-select" onchange="obtenerProvincia(this)">
                                ...
                                <?php foreach ($departamentos as $d) { ?>
                                    <option value="<?php echo $d->ubigeo ?>"><?php echo $d->nombre ?></option>
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <select name="mis_provincias" id="mis_provincias" placeholder="" class="select2 form-select" onchange="obtenerDistrito(this)">
                                <option disabled value="">Selecciona provincia</option>
                            </select>
                        </div>
                        <div class="mb-3 col-md-6">
                            <label for="mis_distritos" class="form-label">Distrito</label>
                            <select name="mis_distritos" id="mis_distritos" class="select2 form-select">
                                <option disabled value="">Selecciona distrito</option>
                            </select>
                        </div>
                        <div class="mb-3 col-md-12">
                            <label for="localidad" class="form-label">Localidad</label>
                            <input type="text" class="form-control" placeholder="" id="localidad" autocomplete="off" required>
                        </div>
                        <div class="col-md-12 mb-3">
                            <div class="mb-3">
                                <label class="form-label">Tipo de zona</label>
                                <div class="zona">
                                    <input type="radio" name="zona" value="1" id="_brote" checked />
                                    <label for="_brote">
                                        Brote
                                    </label>

                                    <input type="radio" name="zona" value="2" id="_nueva" />
                                    <label for="_nueva">
                                        Nueva
                                    </label>
                                    <input type="radio" name="zona" value="3" id="_baja" />
                                    <label for="_baja">
                                        Baja transmisión
                                    </label>
                                </div>
                        ...
                        <div class="mb-3 col-md-12">
                            ...
                            <input type="text" class="form-control" placeholder="" id="direccion" autocomplete="off" required>
                        </div>
                        <div class="col-md-12">
                            <label for="detalle_direccion" class="form-label">Detalle dirección</label>
                            <div class="col-md-12 row m-0 card_ficha detalle_direccion" style="padding: 20px;">
                                <div class="row p-0 m-0">
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input type="text" class="form-control" placeholder="" id="d_nombre_via" autocomplete="off" required>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <label for="d_nro_puerta" class="form-label">N° de puerta</label>
                                        <input type="number" class="form-control" placeholder="" id="d_nro_puerta" autocomplete="off" required>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <label for="d_nro_manzana" class="form-label">N° de manzana</label>
                                        <input type="text" class="form-control" placeholder="" id="d_nro_manzana" autocomplete="off" required>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <label for="d_lote" class="form-label">Lote</label>
                                        <input type="text" class="form-control" placeholder="" id="d_lote" autocomplete="off" required>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <select name="d_tipo_asociacion" id="d_tipo_asociacion" class="select2 form-select" required>
                                            <?php foreach ($tipo_asociacion as $p) { ?>
                                                <option value="<?php echo $p->id ?>"><?php echo $p->denominacion ?></option>
                                    ...
                                    <div class="mb-3 col-md-12">
                                        ...
                                        <input type="text" class="form-control" placeholder="" id="d_nombre_asociacion" autocomplete="off" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="mb-3 col-md-12">
                            ...
                            <input type="text" class="form-control flatpickr-input active" placeholder="" id="fecha_inicio_enfermedad" required>
                        </div>
                        <div class="mb-3 col-md-12">
                            <label for="responsable_epidemiologia" class="form-label">Fecha de muestra</label>
                            <input type="text" class="form-control flatpickr-input active" placeholder="" id="fecha_muestra" required>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 col-lg-3 mb-2">
                            <div class="_gestante">
                                <div class="inputGroup">
                                    <input id="_gestante" name="_gestante" type="checkbox" />
                        ...
                        <div class="col-md-6 col-lg-3 mb-2">
                            <div class="_gestante">
                                <div class="inputGroup">
                                    <input id="_fiebre" name="_fiebre" type="checkbox" />
                        ...
                        <div class="col-md-6 col-lg-3 mb-2">
                            <div class="_gestante">
                                <div class="inputGroup">
                                    <input id="_rash" name="_rash" type="checkbox" />
                        ...
                        <div class="col-md-6 col-lg-3 mb-2">
                            <div class="_gestante">
                                <div class="inputGroup">
                                    <input id="_conjuntivitis" name="_conjuntivitis" type="checkbox" />
                        ...
                        <div class="col-md-6 col-lg-3 mb-2">
                            <div class="_gestante">
                                <div class="inputGroup">
                                    <input id="_artralgia" name="_artralgia" type="checkbox" />
                        ...
                        <div class="col-md-6 col-lg-3 mb-2">
                            <div class="_gestante">
                                <div class="inputGroup">
                                    <input id="_mialgia" name="_mialgia" type="checkbox" />
                        ...
                        <div class="col-md-6 col-lg-3 mb-2">
                            <div class="_gestante">
                                <div class="inputGroup">
                                    <input id="_otros" name="_otros" type="checkbox" />
                        ...
                        <div class="col-md-12 d-none otro_sintomatologia">
                            <label for="_nombre_otro" class="form-label">Nombre de sintomatología</label>
                            <input type="text" class="form-control" placeholder="" autocomplete="off" id="_nombre_otro" name="_nombre_otro">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="mb-3 col-md-12">
                            ...
                            <select name="area_captacion" id="area_captacion" placeholder="" style="width: 100%;" class="select2 form-select">
                        ...
                        <div class="mb-3 col-md-12">
                            ...
                            <textarea rows="2" style="resize: none;" type="text" class="form-control" id="diagnostico_captacion" required placeholder=""></textarea>
                        </div>
                        <div class="mb-3 col-md-12">
                            <label for="evaluacion_paciente" class="form-label">Evaluación del paciente</label>
                            <select name="evaluacion_paciente" id="evaluacion_paciente" placeholder="" style="width: 100%;" class="select2 form-select">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="mb-3 col-md-12">
                            ...
                            <textarea rows="9" style="resize: none;" type="text" class="form-control" id="observacion" placeholder=""></textarea>
                        </div>
                    </div>
                </div>
            </div>
...
<script src="<?php echo base_url('public/js/Vigilancia/jsNuevaFicha.js') . '?=' . rand(); ?>"></script>