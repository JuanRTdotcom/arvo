...
class Serotipos extends CI_Controller
{
	...
	public function index()
	{
		...
		$data['page_name'] 		= "Configuracion/Serotipos_view.php";
		$data['page'] 			= "";

		$this->load->view('plantilla', $data);
	}

	public function listarSerotipos()
	{
		$this->load->model('Serotipos_model', 'serotipos_model');
		$data = $this->serotipos_model->getSerotipos();
		if ($data['estado']) {
