...
(function ($) {
    ...
    $.fn.excelexportjs = function (options) {
        ...
        function ConvertDataStructureToTable() {
            var result = "<table id='tabledata' border='1'>";
            ...
            $($settings.columns).each(function (key, value) {
                if (this.ishidden != true) {
                    result += "<th";
                    if (this.width != null) {
                        result += " style='background-color: #28B463;width: " + this.width + "'";
                    }else{
						result += " style='background-color: #28B463;'";
					}
                    result += ">";
                    result += this.headertext.toUpperCase();
                    result += "</th>";
                }
            });
            result += "</tr></thead>";
